            ...
            >
              <Stack direction={'row'} sx={{ padding: 1.4, height: 54, maxHeight: 54 }}>
                ...
                <Stack direction={'row'} spacing={1}>
                  ...
                  >
                    {data.priority === 'high' ? (
                      <KeyboardDoubleArrowUpIcon sx={{ color: 'rgba(235, 52, 52, 1)' }} />
                    ) : undefined}
                    {data.priority === 'normal' ? (
                      <DragHandleIcon sx={{ color: 'rgba(250, 220, 5, 1)' }} />
                    ) : undefined}
                    {data.priority === 'low' ? (
                      <KeyboardDoubleArrowDownIcon sx={{ color: 'rgba(30, 80, 250, 1)' }} />
                    ) : undefined}
                  </Box>
                </Stack>
              </Stack>
